...
export class DocumentUploadComponent implements OnInit {
  ...
  ngOnInit() {
    this.path = {
      saveUrl: this.storageService.getBaseApiUrl() + 'documents/uploadfiles1',
  ...
  public onuploading(args: any) {
    // args.currentRequest.setRequestHeader('Bearer ' + this.storageService.getCurrentSession().token);
  }
