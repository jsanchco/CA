...
import { GridComponent, ForeignKeyService, EditSettingsModel, ToolbarItems, EditService, ToolbarService } from '@syncfusion/ej2-angular-grids';
...
export class UsersComponent implements OnInit {
  ...
  // public professions: { [key: number]: Object }[];
  ...
  getProfessions(): void {
    this.professionsService.getAll().subscribe(
      data => {
        ...
        //   // let profession: { [key: string]: Object };
        //   // profession[data[i].id] = { id: data[i].id, name: data[i].name }
